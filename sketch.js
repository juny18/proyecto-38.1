...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Distancia: "+ distance,700,30);
 ...
 player1.addAnimation("opponentPlayer1",oppPink2Img);
   ...
   player3.addAnimation("opponentPlayer3",oppRed2Img);
    ...
    textSize(15);  
    fill("white")  
    text("¡Presiona la tecla de Flecha hacia Arriba para reiniciar el juego!",450,200)
...
gameState=PLAY;  
gameOver.visible=false;  
 // mainCyclist.changeAnimation("mainPlayer1","mainPlayer2",mainRacerImg1);
mainCyclist.addAnimation("SahilRunning",mainRacerImg1);// Ocupas la instrucción de la línea 135, que es donde el ciclista se pone de pie.
